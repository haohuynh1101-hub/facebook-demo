...
- <b>assets</b>:save images imported from computer
- <b>common</b>:define resful API
- <b>containers</b>:the place where components connect to store
- <b>Pages</b>:the whole page such as homePage,loginPage,...
- <b>redux</b>: saving state and handling on store
- <b>types</b>: define action types
- <b>utils</b>: define functions to call API
